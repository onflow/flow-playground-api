# Contributing to the Flow Playground

The following is a set of guidelines for contributing to the Flow Playground.
...
- **What is the version of the Playground you're using**?
...
Unsure where to begin contributing to the Flow Playground?
You can start by looking through these `good-first-issue` and `help-wanted` issues:

- [Good first issues](https://github.com/onflow/flow-playground-api/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/onflow/flow-playground-api/labels/help%20wanted):
